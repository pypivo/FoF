...
class EquationsController:
    ...
    def calculate_equations(
        ...
        right_MVA_h =    2.0*H_17 - H_7
        right_OAA_h =    H_22 + H_25 + (1.0/2.0)*H_26  + (1.0/2.0)*H_28 - H_21 - H_23 - H_24
        right_Cit_h =    2.0*H_21 - H_22 - H_26 
        right_AA_h = H_1 - H_27 - H_28 - H_29
        right_NADPH_h =  (1.0/2.0)*H_14 + (1.0/2.0)*H_24 - H_19 - H_17
        ...
        right_OAA_m =    (1.0/3.0)*M_14 + (1.0/2.0)*M_19 - M_13
        right_H_cyt_m =  (1.0/3.0)*M_10  - M_15 - M_2
        right_H_mit_m =  (1.0/2.0)*M_3 + (1.0/2.0)*M_12 + M_15 + (1.0/3.0)*M_14 - M_16
        right_CO2_m =    (1.0/2.0)*M_11 + (1.0/3.0)*M_14
